...
class AreaOfTriangle extends JFrame implements ActionListener {
    ...
    AreaOfTriangle() {
        ...
        jb1 = new JButton("Area Of Triangle");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        int base = Integer.parseInt(jt1.getText());
        int height = Integer.parseInt(jt2.getText());
